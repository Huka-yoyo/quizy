(function ($) {
  ...
  const prefecturalCapital = [
    ...
    },
    {
      ...
      answer04: "急ぎの連絡だから、自転車をこぎながら、携帯を使う",
    },
    {
      id: "04",
    ...
    {
      id: "08",
      question: "友達が悪ふざけをしている動画をSNSにあげた。どのような悪影響があるでしょうか？",
      answer01: "炎上する",
      answer02: "人気者になる",
    ...
    {
      id: "10",
      question: "親のスマホでオンラインゲームをしているとアイテムを買いたくなった。どうしたら良いでしょうか？",
      answer01: "親に聞いてみる",
      answer02: "親に内緒で買う",
      answer03: "買ってから親に伝える",
      answer04: "オンライン上の知らない人に売ってもらう",
    },
  ];
//  -----------------------------------------------------------------------------------------------------------------
